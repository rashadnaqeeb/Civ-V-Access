...
-- container). Missing tooltips are fine -- Menu just appends nothing.
--
...
-- Menu's isNavigable skips them when IsHidden() returns true, so the user
    ...
    tabs = {
        {
            ...
            items     = withButtons({
                ...
                MenuItems.Slider({ controlName = "Tooltip1TimerSlider",
                ...
                MenuItems.Pulldown({ controlName = "TutorialPull",
                    textKey    = "TXT_KEY_OPSCREEN_TUTORIAL_LEVEL",
                    tooltipKey = "TXT_KEY_OPSCREEN_TUTORIAL_LEVEL_TT" }),
                MenuItems.Button({ controlName = "ResetTutorialButton",
        ...
        },
        {
            ...
            items     = withButtons({
                MenuItems.Textfield({ controlName = "AutosaveTurnsEdit",
                ...
                MenuItems.Textfield({ controlName = "AutosaveMaxEdit",
        ...
        },
        {
            ...
            items     = withButtons({
                ...
                MenuItems.Textfield({ controlName = "TurnNotifySmtpEmailEdit",
                    textKey       = "TXT_KEY_CIVVACCESS_OPSCREEN_SMTP_FROM_EMAIL",
                    priorCallback = OnTurnNotifySmtpEmailChanged }),
                MenuItems.Textfield({ controlName = "TurnNotifySmtpHostEdit",
                ...
                MenuItems.Checkbox({ controlName = "TurnNotifySmtpTLS",
                    textKey    = "TXT_KEY_OPSCREEN_TURN_NOTIFY_SMTP_TLS",
                    tooltipKey = "TXT_KEY_OPSCREEN_TURN_NOTIFY_SMTP_TLS_TT" }),
                MenuItems.Textfield({ controlName = "TurnNotifySmtpPortEdit",
                ...
                MenuItems.Textfield({ controlName = "TurnNotifySmtpUserEdit",
                ...
                MenuItems.Textfield({ controlName = "TurnNotifySmtpPassEdit",
...
local graphicsPopup = Menu.create({
    ...
    items = {
        MenuItems.Button({ controlName = "GraphicsChangedOK",
...
local countdownPopup = Menu.create({
    ...
    items = {
        MenuItems.Button({ controlName = "CountNo",
            labelFn  = function(c) return c:GetText() end,
            activate = function()
                countdownUserAction = "no"
                OnCountdownNo()
            end }),
        MenuItems.Button({ controlName = "CountYes",
            labelFn  = function(c) return c:GetText() end,
            activate = function()
