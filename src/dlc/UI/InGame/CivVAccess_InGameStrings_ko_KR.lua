...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_UNIT_PRECHECK_AIR_NO_DIRECT_MOVE"] = "항공기는 이 방법으로 이동 불가, 재배치 사용"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_UNIT_PREVIEW_ATTACK"] = "{1_Name}, {2_MyStr} 대 {3_TheirStr}, {4_Result}, 내 피해 {5_DmgToMe}, 상대 피해 {6_DmgToThem}"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_UNIT_PREVIEW_RANGED"] = "{1_Name}, {2_MyStr} 대 {3_TheirStr}, {4_Result}, 상대 피해 {5_DmgToThem}"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_UNIT_PREVIEW_ATTACK_CITY"] = "도시 {1_Name}, {2_MyStr} 대 {3_TheirStr}, 내 피해 {4_DmgToMe}, 상대 피해 {5_DmgToThem}"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_UNIT_PREVIEW_RANGED_CITY"] = "도시 {1_Name}, {2_MyStr} 대 {3_TheirStr}, 상대 피해 {4_DmgToThem}"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_UNIT_PREVIEW_MOVE_PATH_FOG_PREFIX_THIS_TURN"] = "이번 턴, {1_Steps} 후 미탐험"
...
-- ===== Path diagnostics.
CivVAccess_Strings["TXT_KEY_CIVVACCESS_PATH_BLOCKED_BORDERS_CIV"] = "{1_Civ} 국경에 막힘, 가장 가까운 도달 가능 위치 {2_Dir}"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_PATH_BLOCKED_BORDERS_CIV_NO_DIR"] = "{1_Civ} 국경에 막힘"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_PATH_BLOCKED_BORDERS"] = "폐쇄 국경에 막힘, 가장 가까운 도달 가능 위치 {1_Dir}"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_PATH_BLOCKED_UNIT"] = "{1_Unit}에 막힘, 가장 가까운 도달 가능 위치 {2_Dir}"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_PATH_BLOCKED_UNIT_NO_DIR"] = "{1_Unit}에 막힘"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_PATH_BLOCKED_UNIT_FALLBACK"] = "유닛에 막힘, 가장 가까운 도달 가능 위치 {1_Dir}"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_PATH_BLOCKED_UNIT_FALLBACK_NO_DIR"] = "유닛에 막힘"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_PATH_UNREACHABLE_CLOSEST"] = "경로 없음, 가장 가까운 도달 가능 위치 {1_Dir}"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_PATH_NO_EMBARK_TECH"] = "승선 기술 없음, 가장 가까운 도달 가능 위치 {1_Dir}"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_PATH_NO_EMBARK_TECH_NO_DIR"] = "승선 기술 없음"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_PATH_NEEDS_ASTRONOMY"] = "천문학 필요, 가장 가까운 도달 가능 위치 {1_Dir}"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_PATH_NEEDS_ASTRONOMY_NO_DIR"] = "천문학 필요"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_PATH_BLOCKED_MOUNTAIN"] = "산에 막힘, 가장 가까운 도달 가능 위치 {1_Dir}"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_PATH_BLOCKED_MOUNTAIN_NO_DIR"] = "산에 막힘"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_PATH_BLOCKED_WONDER"] = "{1_Wonder}에 막힘, 가장 가까운 도달 가능 위치 {2_Dir}"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_PATH_BLOCKED_WONDER_NO_DIR"] = "{1_Wonder}에 막힘"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_PATH_NO_WATER_CONNECTION"] = "수상 연결 없음, 가장 가까운 도달 가능 위치 {1_Dir}"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_PATH_NO_WATER_CONNECTION_NO_DIR"] = "수상 연결 없음"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_PATH_CANT_ATTACK_FROM_LAND"] = "육지에서 공격 불가, 가장 가까운 도달 가능 위치 {1_Dir}"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_PATH_CANT_ATTACK_FROM_LAND_NO_DIR"] = "육지에서 공격 불가"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_PATH_CANT_ATTACK_FROM_WATER"] = "수상에서는 공격할 수 없습니다. 가장 가까운 도달 가능한 방향: {1_Dir}"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_PATH_CANT_ATTACK_FROM_WATER_NO_DIR"] = "수상에서는 공격할 수 없습니다."
CivVAccess_Strings["TXT_KEY_CIVVACCESS_PATH_CANT_TRAVEL_TO_LAND"] = "육지로 이동할 수 없습니다. 가장 가까운 도달 가능한 방향: {1_Dir}"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_UNIT_REBASE_NO_DESTINATIONS"] = "사거리 내에 재주둔 가능한 목적지 없음"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_UNIT_REBASED_TO"] = "{1_Name}(으)로 재주둔했습니다."

-- Airlift sub-menu
CivVAccess_Strings["TXT_KEY_CIVVACCESS_UNIT_AIRLIFT_PREAMBLE"] = "이 유닛을 공수할 도시를 선택하십시오. 도시를 선택한 후, 유닛이 착륙할 정확한 타일을 선택하십시오. 도시에서 1타일 이내여야 합니다."
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_UNIT_PREVIEW_GIFT_UNIT_ILLEGAL"] = "이 위치에서 유닛을 증여할 수 없습니다."
CivVAccess_Strings["TXT_KEY_CIVVACCESS_UNIT_PREVIEW_GIFT_IMPROVEMENT_ILLEGAL"] = "이 위치를 개선할 수 없습니다."
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_UNIT_PREVIEW_GIFT_IMPROVEMENT_LEGAL"] = "{2_Recipient}을 위해 {1_Resource} 개선"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_UNIT_HELP_DESC_CYCLE_ALL"] = "이미 행동한 유닛을 포함하여 다음 또는 이전 유닛으로 순환"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_UNIT_HELP_DESC_ALT_MOVE"] = "선택된 유닛을 한 타일 이동 (공격 확인은 두 번 누르기)"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_UNIT_HELP_KEY_ALT_MOVE_TO"] = "Alt 플러스 M"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_UNIT_HELP_DESC_ALT_MOVE_TO"] = "이동 목적지 선택기 열기. 방향키로 조준, 스페이스로 미리보기, Enter로 확정"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_UNIT_HELP_KEY_ALT_SLEEP"] = "Alt 플러스 S"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_UNIT_HELP_DESC_ALT_SLEEP"] = "군사 유닛 방어 태세 또는 민간 유닛 휴식"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_UNIT_HELP_KEY_ALT_SENTRY"] = "Alt 플러스 F"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_UNIT_HELP_DESC_ALT_SENTRY"] = "경계. 적이 시야에 들어올 때까지 대기"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_UNIT_HELP_KEY_ALT_WAKE"] = "Alt 플러스 W"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_UNIT_HELP_DESC_ALT_WAKE"] = "휴식 중이거나 방어 태세인 유닛을 깨우거나, 대기 중인 이동 또는 자동화 취소"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_UNIT_HELP_DESC_ALT_RANGED"] = "원거리 공격 목적지 선택기 열기. 방향키로 조준, 스페이스로 미리보기, Enter로 확정"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_CURSOR_HELP_DESC_MOVE"] = "커서 이동 (Q: 북서, E: 북동, A: 서, D: 동, Z: 남서, C: 남동)"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_CURSOR_HELP_KEY_NUMPAD"] = "숫자 키패드 7, 8, 9, 4, 5, 6, 1, 2, 3"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_CURSOR_HELP_DESC_NUMPAD"] = "동일한 보조 키와 함께 Q, W, E, A, S, D, Z, X, C를 반영 (숫자 키패드 5는 S에 해당, NumLock 켜짐)"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_CURSOR_HELP_DESC_COORDINATES"] = "수도 기준 커서 좌표 (동쪽 이동 시 x +1, 북동 이동 시 x +0.5 y +1, 남동 이동 시 x +0.5 y -1)"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_CURSOR_HELP_DESC_ACTIVATE"] = "유닛 선택 또는 도시 화면 열기 (괴뢰 도시는 합병 팝업, 만난 주요 문명은 외교)"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_CURSOR_HELP_KEY_PEDIA"] = "Ctrl+I"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_CURSOR_HELP_DESC_PEDIA"] = "커서 위치의 항목 문명 백과 열기 (유닛, 불가사의, 개선, 자원, 특징, 강, 호수, 지형, 구릉, 산, 경로)"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_SETTINGS_FOREIGN_CLEAR_ANNOUNCE"] = "시야 내 다른 세력이 야영지 또는 유적 점령 시 알림"
...
-- Great People tab
CivVAccess_Strings["TXT_KEY_CIVVACCESS_MO_GP_CITY_ROW"] = "{1_City}: {2_Turns}, {3_Progress}/{4_Threshold}, 턴당 {5_Rate} 증가"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_CITYVIEW_SPECIALIST_SLOT"] = "{1_Building} {2_Specialist} 슬롯 {3_N}, {4_State}"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_CITYVIEW_SPECIALIST_FILLED_FROM_TILE"] = "채움, 타일에서 노동자 배정 해제됨"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_CITYVIEW_SPECIALIST_UNFILLED_TO_TILE"] = "비어 있음, 노동자 타일에 배정됨"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_CITYVIEW_GW_THEMING_BONUS"] = "{1_Building} 테마 보너스 +{2_Amount}. {3_Tip}"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_CITYVIEW_PROD_SLOT1_TRAIN_INFINITE"] = "슬롯 1, {1_Name}, {2_Percent} 퍼센트. {3_Help}"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_CITY_RANGED_PREVIEW"] = "{1_Name}, {2_MyStr} 대 {3_TheirStr}, 상대방에게 {4_Dmg} 피해"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_CITY_RANGED_HELP_KEY_PREVIEW"] = "Space"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_CITY_RANGED_HELP_DESC_PREVIEW"] = "목표 정보 읽기"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_CITY_RANGED_HELP_KEY_COMMIT"] = "Enter"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_CITY_RANGED_HELP_DESC_COMMIT"] = "현재 목표 공격"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_CITY_RANGED_HELP_KEY_CANCEL"] = "Escape"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_CITY_RANGED_HELP_DESC_CANCEL"] = "공격 없이 취소"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_GIFT_HELP_DESC_PREVIEW"] = "목표 정보 읽기"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_GIFT_HELP_KEY_COMMIT"] = "Enter"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_GIFT_HELP_DESC_COMMIT"] = "현재 목표에 증여 실행"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_GIFT_HELP_KEY_CANCEL"] = "Escape"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_GIFT_HELP_DESC_CANCEL"] = "증여 없이 취소"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_CITYVIEW_NO_CYCLE_SPYING"] = "스파이 활동 중에는 도시 전환 사용 불가"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_CITYVIEW_FOREIGN_NO_RANGED"] = "소유하지 않은 도시에서 원거리 공격을 실행할 수 없습니다"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_CITYVIEW_FOREIGN_NO_PRODUCTION"] = "소유하지 않은 도시의 생산을 변경할 수 없습니다"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_CITYVIEW_FOREIGN_NO_WORK_TILE"] = "소유하지 않은 도시의 타일을 작업할 수 없습니다"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_CITYVIEW_FOREIGN_NO_BUY_PLOT"] = "소유하지 않은 도시의 타일을 구매할 수 없습니다"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_CITYVIEW_FOREIGN_NO_SELL"] = "소유하지 않은 도시의 건물을 판매할 수 없습니다"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_CITYVIEW_FOREIGN_NO_FOCUS"] = "소유하지 않은 도시의 집중을 변경할 수 없습니다"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_CITYVIEW_FOREIGN_NO_SPECIALIST"] = "소유하지 않은 도시의 전문가를 관리할 수 없습니다"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_CITYVIEW_FOREIGN_NO_GREAT_WORK_OPEN"] = "소유하지 않은 도시의 위대한 예술품을 열람할 수 없습니다"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_CITYVIEW_FOREIGN_NO_SLACKER"] = "소유하지 않은 도시에서는 시민을 배치할 수 없습니다."
...
-- Foreign-unit watch
CivVAccess_Strings["TXT_KEY_CIVVACCESS_FOREIGN_HOSTILE_ENTERED"] = "새로 시야에 들어온 적대적 유닛: {1_List}"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_TURN_HELP_KEY_END"] = "Control 플러스 Space"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_TURN_HELP_DESC_END"] = "턴 종료, 또는 첫 번째 차단 항목을 알리고 열기"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_TURN_HELP_KEY_FORCE"] = "Control 플러스 Shift 플러스 Space"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_TURN_HELP_DESC_FORCE"] = "유닛 명령 필요 알림을 무시하고 턴 종료. 다른 차단 항목은 계속 알리고 열림."
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_STATUS_POLICY_STALLED"] = "문화 없음, 다음 정책까지 {2_Cost}점 중 {1_Cur}점"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_STATUS_HELP_DESC_TURN"] = "턴 및 날짜. 유닛 상한 초과 시 공급 현황과 전략 자원 부족 항목 포함."
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_STATUS_HELP_DESC_HAPPINESS"] = "제국 행복도, 행복을 제공하는 사치 자원 수, 황금기 현황"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_STATUS_HELP_DESC_HAPPINESS_DETAIL"] = "행복 원천, 불행 원천, 황금기 효과"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_STATUS_HELP_KEY_FAITH_DETAIL"] = "Shift 플러스 F"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_STATUS_HELP_DESC_FAITH_DETAIL"] = "출처별 신앙 세부 내역과 예언자 또는 만신전 획득 시기"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_STATUS_HELP_DESC_TOURISM_DETAIL"] = "걸작, 빈 슬롯, 영향력 있는 문명 수"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_PICKER_READER_NO_SELECTION"] = "선택된 항목이 없습니다. 분류 탭으로 이동하여 항목을 선택하십시오."
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_SAVE_INVALID_NAME"] = "저장 이름이 비어 있거나 유효하지 않은 문자가 포함되어 있습니다."
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_SAVE_OVERWRITE_CLOUD_CONFIRM"] = "Steam Cloud 슬롯 {1_Num}을(를) 덮어쓰시겠습니까?"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_TECHTREE_HELP_DESC_NAV_GRID"] = "Up/Down으로 시대 열 이동, Left/Right으로 행 이동"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_TECHTREE_HELP_DESC_NAV_TREE"] = "Right로 연결 기술, Left로 선행 기술, Up/Down으로 형제 기술 이동"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_SOCIALPOLICY_SLOT_EMPTY_AVAILABLE"] = "슬롯 {1_Num}, 비어 있음, 사용 가능"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_SOCIALPOLICY_SLOT_EMPTY_REQ_SLOT"] = "슬롯 {1_Num}, 비어 있음, 슬롯 {2_Req} 필요"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_SOCIALPOLICY_SLOT_EMPTY_REQ_CROSS"] = "슬롯 {1_Num}, 비어 있음, 레벨 {2_Level} 슬롯 {3_Req} 필요"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_SOCIALPOLICY_SLOT_EMPTY_CULTURE"] = "슬롯 {1_Num}, 비어 있음, 문화 부족"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_SOCIALPOLICY_CONFIRM_ADOPT_POLICY"] = "{1_Name}을(를) 채택하시겠습니까?"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_SOCIALPOLICY_CONFIRM_OPEN_BRANCH"] = "{1_Name} 분기를 개방하시겠습니까?"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_LEADER_DESC_LEADER_ASKIA"] = "송가이의 아스키아 대제 모하마드 1세는 석양 무렵 바위투성이 절벽 위에 서 있으며, 긴 칼날을 어깨에 메고 등 뒤로는 도시가 불타고 있습니다. 그는 검은 피부에 짧은 수염을 기르고 있으며, 눈은 관람자를 향해 고정되어 있습니다. 머리는 타겔무스트로 감싸여 있는데, 한쪽으로 모아진 연한 크림색의 사헬 터번이 높게 감겨 있습니다. 어깨에는 서아프리카 귀족의 넓은 소매 로브인 짙은 진홍색 부부가 드리워져 있으며, 전면 패널과 가슴에는 금색과 검은 실로 촘촘히 문양 수가 놓인 띠가 이어집니다. 그 아래로 연한 새시가 허리에 감겨 매듭지어지며 엉덩이 옆으로 끝이 느슨하게 늘어지고, 같은 진홍색의 바지 위로 걸쳐져 있습니다. 오른손으로 칼자루를 쥐고 칼날을 어깨 위로 눕혀 받치고 있으며, 칼은 길고 등이 곧으며 끝으로 갈수록 약간의 곡선을 이룹니다. 오른쪽으로 땅은 낮은 태양을 배경으로 검게 실루엣을 이룬 산이 붉은 주황빛 하늘 아래 평원으로 내려앉습니다. 왼쪽으로는 도시가 불타고 있습니다. 흙벽돌 성벽과 돌출된 나무 토론의 줄로 촘촘히 박힌 높은 사각 미나렛이 있으며, 석고에서 삐져나온 야자나무 들보가 그대로 남아 있습니다. 불길이 탑을 타오르며 아래 거리를 감싸고, 더 작은 불들이 도시와 그가 서 있는 절벽 사이 평원 곳곳에 흩어져 있습니다."
CivVAccess_Strings["TXT_KEY_CIVVACCESS_LEADER_DESC_LEADER_ISABELLA"] = "카스티야와 레온의 여왕이자 아라곤의 왕비인 이사벨라 1세는 그라나다 알람브라 궁전의 기둥 회랑 중 하나에 서 있으며, 아케이드는 다듬어진 생울타리와 화분 속 조형 수목이 있는 정원으로 열려 있고, 언덕들은 저 멀리 안개 속으로 희미해집니다. 조각된 주두를 가진 가느다란 쌍기둥이 그녀 뒤로 격자 세공으로 채워진 엽편 형태와 가리비 형태의 아치로 솟아오르며, 그 위 스팬드럴은 연한 금색과 모래색 톤의 촘촘한 기하학적, 식물 문양의 치장 벽토로 조각되어 있습니다. 그녀는 가냘프고 창백하며, 양손을 허리 앞에 포개고 있습니다. 머리는 카스티야 궁정 양식으로 덮여 있는데, 턱 아래와 목 앞으로 가깝게 드리운 흰 윔플, 머리 위에 꼭 맞는 흰 베일, 그리고 그 위로 붉은색과 초록색 보석이 박힌 작은 닫힌 금관이 얹혀 있습니다. 어깨에는 금 테두리로 장식되어 앞쪽으로 열린 긴 붉은 망토가 드리워져 있습니다. 그 아래 드레스는 어두운 반복 문양의 크림 브로케이드로, 꼭 맞는 보디스에 치마 중앙으로 금 테두리 패널이 내려옵니다. 가슴에는 망토가 벌어지는 곳에 붉은 보석이 고정되어 있습니다. 빛은 늦은 오후의 따뜻하고 낮은 빛으로, 아케이드의 치장 벽토와 회랑 석조 바닥을 잡아냅니다."
...
-- Demographics (DEMO)
CivVAccess_Strings["TXT_KEY_CIVVACCESS_DEMO_ROW"] = "{1_Metric}, {2_Rank}위, {3_Value}, 최고 {4_BestCiv} {5_BestVal}, 평균 {6_AvgVal}, 최저 {7_WorstCiv} {8_WorstVal}"
...
-- Tab 1 (Your Culture).
CivVAccess_Strings["TXT_KEY_CIVVACCESS_CO_ANTIQUITY_SITES"] = "고대 유적지: {1_Visible}개 발견됨, {2_Hidden}개 숨겨짐"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_CO_BUILDING_LABEL_THEMED"] = "{1_Name}, {2_SlotType}, {3_Filled}/{4_Total}, 테마 보너스 +{5_Bonus}"
...
-- Slot tooltip forms.
CivVAccess_Strings["TXT_KEY_CIVVACCESS_CO_GW_TOOLTIP_AUTHORED"] = "{1_Class}, 제작자 {2_Artist}, {3_OriginCiv}, {4_Era}, 문화 +{5_Cul}, 관광 +{6_Tou}"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_CO_GW_TOOLTIP_NOCLASS"] = "제작자 {1_Artist}, {2_OriginCiv}, {3_Era}, 문화 +{4_Cul}, 관광 +{5_Tou}"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_CO_GW_TOOLTIP_ARTIFACT"] = "{1_Class}, {2_OriginCiv}, {3_Era}, 문화 +{4_Cul}, 관광 +{5_Tou}"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_CO_GW_MOVE_TYPE_MISMATCH"] = "현재 원본과 슬롯 유형이 맞지 않습니다."
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_CO_SWAP_NO_OFFERINGS"] = "교환 가능한 작품을 제공하는 문명이 없습니다."
CivVAccess_Strings["TXT_KEY_CIVVACCESS_CO_SWAP_FOREIGN_NO_SLOTS"] = "교환 가능한 작품 없음"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_CO_SWAP_TRADE_NOT_PICKED"] = "교환할 다른 문명의 작품을 선택하십시오."
CivVAccess_Strings["TXT_KEY_CIVVACCESS_CO_SWAP_TRADE_NEED_DESIGNATE"] = "{3_TheirCiv}의 {2_TheirName}과 교환할 {1_Type}이 지정되지 않았습니다. 내 제공 작품에서 지정하십시오."
CivVAccess_Strings["TXT_KEY_CIVVACCESS_CO_SWAP_TRADE_READY"] = "내 {1_YourName}을 {3_TheirCiv}의 {2_TheirName}과 교환합니다."
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_CO_INFLUENCE_PERSPECTIVE_CELL"] = "턴당 관광 {1_N} 생성 중, Enter 키를 눌러 이 시점으로 전환합니다."
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_CO_INFLUENCE_PERCENT_TOOLTIP"] = "내 관광 {1_Yours}, 상대 누적 문화 {2_Theirs}"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_CO_DISABLED"] = "이 게임에서는 문화 개요를 사용할 수 없습니다."
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_ESPIONAGE_DISABLED"] = "이 게임에서 첩보는 비활성화되어 있습니다."
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_BOOKMARK_HELP_DESC_SAVE"] = "커서 위치를 해당 슬롯에 북마크로 저장합니다."
CivVAccess_Strings["TXT_KEY_CIVVACCESS_BOOKMARK_HELP_KEY_JUMP"] = "Shift 플러스 숫자 키"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_BOOKMARK_HELP_DESC_JUMP"] = "해당 슬롯의 북마크로 커서를 이동합니다. 뒤로 가기로 돌아올 수 있습니다."
CivVAccess_Strings["TXT_KEY_CIVVACCESS_BOOKMARK_HELP_KEY_DIRECTION"] = "Alt 플러스 숫자 키"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_BOOKMARK_HELP_DESC_DIRECTION"] = "커서에서 해당 슬롯의 북마크까지의 거리와 방향"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_BEACON_HELP_DESC"] = "해당 슬롯의 북마크에 공간 음향 비콘을 켜거나 끕니다."
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_MSGBUF_HELP_KEY_EDGE"] = "Control 플러스 왼쪽 대괄호와 오른쪽 대괄호"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_MSGBUF_HELP_DESC_EDGE"] = "버퍼에서 가장 오래된 또는 최신 메시지"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_MSGBUF_HELP_KEY_FILTER"] = "Shift 플러스 왼쪽 대괄호와 오른쪽 대괄호"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_MSGBUF_HELP_DESC_FILTER"] = "버퍼 필터 분류를 순환합니다. 빈 분류는 건너뜁니다."

-- Multiplayer chat
CivVAccess_Strings["TXT_KEY_CIVVACCESS_CHAT_HOTKEY_HELP_KEY"] = "Backslash"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_CHAT_HOTKEY_HELP_DESC"] = "멀티 플레이 채팅 패널 열기. 싱글 플레이에서는 동작하지 않습니다."
