...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_BUILD_UNAVAILABLE_WITH_REASON"] = "不可用, {1_BuildName}, {2_Reason}"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_BUILD_UNAVAILABLE"] = "不可用, {1_BuildName}"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_UNIT_ACTION_UNAVAILABLE"] = "不可用, {1_Action}"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_TARGET_HELP_DESC_PREVIEW"] = "預覽對目標格的行動"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_TARGET_HELP_KEY_WAYPOINT_PREVIEW"] = "Shift 加 Space"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_TARGET_HELP_DESC_COMMIT"] = "對目標格執行行動"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_TARGET_HELP_KEY_QUEUE"] = "Shift 加 Enter"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_TARGET_HELP_DESC_QUEUE"] = "將行動加入單位任務清單"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_TARGET_HELP_KEY_CANCEL"] = "Escape"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_TARGET_HELP_DESC_CANCEL"] = "取消目標模式"
...
-- ===== Path diagnostics =====
CivVAccess_Strings["TXT_KEY_CIVVACCESS_PATH_BLOCKED_BORDERS_CIV"] = "受 {1_Civ} 邊界阻擋, 最近可到達 {2_Dir}"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_PATH_BLOCKED_FOGGED"] = "受阻擋, 最近可到達 {1_Dir}"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_PATH_BLOCKED_FOGGED_NO_DIR"] = "受阻擋"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_PATH_ROUTE_BLOCKED_WATER"] = "受水域阻擋, 最近可到達 {1_Dir}"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_PATH_ROUTE_BLOCKED_WATER_NO_DIR"] = "受水域阻擋"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_UNIT_HELP_KEY_CYCLE_AZERTY"] = "冒號, 分號"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_UNIT_HELP_KEY_CYCLE_ALL_AZERTY"] = "Control 加 冒號或分號"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_UNIT_HELP_KEY_INFO_AZERTY"] = "驚嘆號"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_UNIT_HELP_KEY_INFO_QWERTZ"] = "連字號"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_UNIT_HELP_KEY_INFO_ITALIAN"] = "連字號"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_UNIT_HELP_KEY_RECENTER_AZERTY"] = "Control 加 驚嘆號"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_UNIT_HELP_KEY_RECENTER_QWERTZ"] = "Control 加 連字號"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_UNIT_HELP_KEY_RECENTER_ITALIAN"] = "Control 加 連字號"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_UNIT_HELP_DESC_ALT_MOVE"] = "移動所選單位一格 (雙按確認攻擊)"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_DIR_NE_LONG"] = "東北"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_DIR_SE_LONG"] = "東南"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_DIR_SW_LONG"] = "西南"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_DIR_W_LONG"] = "西"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_DIR_NW_LONG"] = "西北"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_PLOT_WAYPOINT_NAMED"] = "{1_Name} 路徑點"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_IN_CIV_TERRITORY"] = "在 {1_CivAdjective} 領土內"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_CURSOR_HELP_DESC_MOVE"] =
    "按格移動游標 (Q 西北, E 東北, A 西, D 東, Z 西南, C 東南)"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_CURSOR_HELP_DESC_NUMPAD"] =
    "以相同修飾鍵反映 Q, W, E, A, S, D, Z, X, C (數字鍵盤 5 對應 S, 須開啟 Num Lock)"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_CURSOR_HELP_DESC_COORDINATES"] =
    "游標至原始首都的距離與方向, 以與其他方向播報相同的格式表示; 若已開啟游標座標設定, 則顯示相對首都的座標"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_HELP_KEY_ALT_HOME_END"] = "Alt 加 Home 或 End"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_HELP_DESC_REVIEW_FIRST_LAST"] = "第一或最後一節"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_HELP_DESC_IMAGE_DESC"] = "描述圖像"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_HELP_GROUP_MORE"] = "更多幫助"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_HELP_OPEN_README"] = "開啟模組說明文件"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_HELP_OPEN_DISCORD"] = "加入模組 Discord 伺服器"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_SETTINGS_GROUP_CURSOR"] = "游標設定"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_SETTINGS_GROUP_AUDIO"] = "音訊設定"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_SETTINGS_GROUP_SCANNER"] = "掃描器設定"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_SETTINGS_KEEP_FOCUS"] = "在背景中持續執行遊戲"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_SETTINGS_BEACON_VOLUME"] = "信標音量"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_SETTINGS_BEACON_VOLUME_VALUE"] = "信標音量, {1_Num} 百分比"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_SETTINGS_SCANNER_COMPASS_DIRECTION"] = "掃描器使用羅盤方位"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_SETTINGS_SCANNER_GROUP_CITIES"] = "掃描器依文明分組城市"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_SETTINGS_SCANNER_GROUP_NAMED_UNITS"] = "掃描器依類型分組已命名單位"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_SETTINGS_SCANNER_DIRECTION_BEEP"] = "掃描器播放方向提示音"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_SETTINGS_SCANNER_WAYPOINTS_SELECTED_ONLY"] =
    "掃描器中僅顯示已選取單位的路徑點"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_SETTINGS_SCANNER_DIRECTION_SCOPE"] = "掃描器可將項目限制為單一方向"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_SETTINGS_ENEMY_ADJACENT_WARN"] = "與敵方相鄰時警告"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_SETTINGS_MAP_HIGHLIGHT"] = "在螢幕上標示游標與掃描器"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_SETTINGS_DIRECTION_LONG_FORM"] = "完整羅盤方向"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_SETTINGS_KEYBOARD_LAYOUT"] = "鍵盤配置"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_SETTINGS_KEYBOARD_ITALIAN"] = "意大利文"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_SETTINGS_UNIT_MOVES_OWN_MILITARY"] = "您的已排程軍事移動"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_SETTINGS_UNIT_MOVES_OWN_CIVILIAN"] = "您的已排程平民移動"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_SETTINGS_UNIT_MOVES_HOSTILE_MILITARY"] = "敵對軍事單位"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_SETTINGS_UNIT_MOVES_HOSTILE_CIVILIAN"] = "敵對平民單位"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_SETTINGS_UNIT_MOVES_NEUTRAL_MILITARY"] = "中立軍事單位"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_SETTINGS_UNIT_MOVES_NEUTRAL_CIVILIAN"] = "中立平民單位"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_SETTINGS_UNIT_MOVES_CITY_STATE_MILITARY"] = "城邦軍事單位"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_SETTINGS_UNIT_MOVES_CITY_STATE_CIVILIAN"] = "城邦平民單位"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_SETTINGS_UNIT_MOVES_BARBARIAN_MILITARY"] = "野蠻人軍事單位"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_SETTINGS_UNIT_MOVES_BARBARIAN_CIVILIAN"] = "野蠻人俘虜的平民單位"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_SETTINGS_UNIT_MOVES_TEAMMATE_MILITARY"] = "隊友軍事單位"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_SETTINGS_UNIT_MOVES_TEAMMATE_CIVILIAN"] = "隊友平民單位"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_SETTINGS_RESET"] = "重設所有設定為預設值"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_SETTINGS_RESET_CONFIRM"] = "重設所有設定為預設值?"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_SETTINGS_RESET_DONE"] = "設定已重設."
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_DIPLO_PEACE_TREATY"] = "和平條約"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_KIND_LINK"] = "連結"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_SCREEN_CC_VOTE"] = "選擇玩家"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_SCREEN_PROPOSAL"] = "提議"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_PROPOSAL_TALLY"] = "已收到 {1_Received} / {2_Max} 票, 缺少 {3_Missing} 票"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_PROPOSAL_EXPIRES"] = "第 {1_Turn} 回合到期"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_PROPOSAL_VOTER"] = "{1_Name}, {2_Status}"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_PROPOSAL_VOTED"] = "已投票"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_PROPOSAL_NOT_VOTED"] = "尚未投票"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_PROPOSAL_NOT_ELIGIBLE"] = "無投票資格"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_PROPOSAL_VOTE_YES"] = "投贊成票"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_PROPOSAL_VOTE_NO"] = "投反對票"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_UNIT_MOVE"] = "{1_Name} 移動 {2_Steps}"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_UNIT_MOVE_OWN"] = "您的 {1_Name} 移動 {2_Steps}"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_UNIT_MOVES_GROUP"] = "單位移動"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_UNIT_MOVES_EMPTY"] = "本回合無單位移動."
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_MO_COL_SQUAD"] = "小隊"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_MO_SQUAD_NONE"] = "無"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_CITYVIEW_YIELD_GOLDEN_AGE"] = "黃金時代點數 {1_Num}"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_CITYVIEW_HELP_KEY_PREV_AZERTY"] = "分號"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_CITYVIEW_PROD_MOVE_TOP"] = "移到頂部"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_CITYVIEW_PROD_MOVE_BOTTOM"] = "移到底部"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_CITYVIEW_PROD_MOVED_TOP"] = "已移到頂部"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_RENAME_TOO_SHORT"] = "名稱必須至少有3個字元. 已取消."
CivVAccess_Strings["TXT_KEY_CIVVACCESS_RENAME_INVALID_CHARS"] = "名稱包含無效字元. 已取消."
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_CITYVIEW_FOREIGN_NO_RANGED"] = "您無法為非己方城市發動遠程攻擊"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_CITYVIEW_FOREIGN_NO_PRODUCTION"] =
    "您無法更改非己方城市的生產項目"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_CITYVIEW_FOREIGN_NO_WORK_TILE"] = "您無法為非己方城市耕作格位"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_CITYVIEW_FOREIGN_NO_SPECIALIST"] = "您無法管理非己方城市的專家"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_CITYVIEW_FOREIGN_NO_GREAT_WORK_OPEN"] = "您無法查看非己方城市的巨作"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_CITYVIEW_FOREIGN_NO_SLACKER"] = "您無法在非己方城市指派市民"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_FOREIGN_ENTERED_HOSTILE_GROUP"] = "視野內有新敵方單位"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_FOREIGN_ENTERED_NEUTRAL_GROUP"] = "視野內有新中立單位"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_FOREIGN_ENTERED_NUMBERED"] = "{1_Name} {2_Num}"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_FOREIGN_UNIT_GONE"] = "已不在視野內"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_PEDIA_SEARCH_PROMPT"] = "搜尋"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_PEDIA_SEARCH_RESULTS"] = {
    other = "{1_N} 個結果",
}
CivVAccess_Strings["TXT_KEY_CIVVACCESS_PEDIA_SEARCH_NO_MATCH"] = "找不到 {1_Query}"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_HELP_KEY_CTRL_F"] = "Control 加 F"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_HELP_DESC_PEDIA_SEARCH"] = "搜尋文章內容"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_TECHTREE_STEAL_COST"] = "竊取成本 {1_Num} 科技值"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_DIPLO_COL_DECLARE_WAR"] = "宣戰"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_LEADER_DESC_LEADER_PEDRO"] =
    "佩德羅二世, 巴西皇帝, 坐在一間深色護牆板書房裡一張寬大的木制書桌前, 畫面的構圖如同觀者站在書桌對面望向他. 他是一位年長的男性, 寬肩厚實, 蓄著一把白色大鬍鬚, 垂落至衣領以下甚遠, 頭頂稀疏的白髮從高闊的前額向後梳理. 他身穿深色長禮服外套, 裡面是深色背心和高領白色襯衫, 喉間繫著深色領巾. 左胸別著南十字星帝國勳章的寶石勛星, 他是該勳章的大團長. 雙手平放在書桌上; 他面前散落著文件和一個小墨水瓶, 一根羽毛筆直立在右手邊的圓形筆座中. 書桌左側放著一盞點亮的油燈, 配有高聳的透明玻璃燈罩和拋光黃銅底座, 燈焰是畫中最亮的點, 也是照亮他臉部和雙手的主要光源. 他身後和兩側, 牆壁從地板到天花板排列著深陷在陰影中的書架. 左肩處一扇高窗透過斜置的木制百葉窗映出一片深藍色夜空, 棕櫚葉在窗外剪影而立. 畫面最左側, 一扇較小的菱形鑲嵌玻璃窗捕捉著暮色天空的暖色調, 窗下一個架子上放著一個小型壁爐架鐘. 地板覆蓋著帶有低調紅色和金色圖案的地毯."
CivVAccess_Strings["TXT_KEY_CIVVACCESS_LEADER_DESC_LEADER_THEODORA"] =
    "狄奧多拉, 羅馬人的奧古斯塔 (Augusta), 斜倚在開放式柱廊露台上一張低矮的金色錦緞長榻上, 一臂搭在長枕上, 另一臂放在膝上. 她的冠冕是一頂寶石 stemma (拜占庭皇冠), 拜占庭帝國頭飾的圓頂帽, 帽帶上鑲嵌著一排素面寶石. 前額正中突顯著一顆綠色寶石, 其上的冠頂向上升起, 以金工夾持著第二顆綠色寶石. 她的頭髮在冠後收攏, 長長垂落在右肩. Pendilia (寶冠垂飾), 即 stemma 的珍珠垂墜, 懸在她臉頰兩側; 一圈 maniakis (帝國項飾) 環繞她的頸部, 這是東方帝國鑲寶石的項圈. 她的長袍層疊穿著: 一件收身的深紅色胸衣, 正中以金色圓形勛章扣合; 膝上鋪著一條金綠色絲綢裙, 繡有渦卷紋; 其下是一條深藍綠色長底裙, 衣擺以窄金帶收邊. 金色袖箍環繞她的手腕. 她身後右側垂下一幅厚重的紅色幔帳, 向一側拉開, 露出帳後的景象. 露台地面鋪著暖色調石板, 邊緣圍著雕刻欄桿, 欄桿上擺放著插滿紅色花朵的花缸, 兩根蒼白的大理石柱框出遠景. 穿越一片寬闊的山谷, 聖索菲亞大教堂巍然矗立, 寬大的中央穹頂兩側伴著較低的半圓形穹頂, 陽光下牆面呈現出黃褐色, 晴空下低矮的山丘在其後漸漸消融為藍色."
CivVAccess_Strings["TXT_KEY_CIVVACCESS_LEADER_DESC_LEADER_DIDO"] =
    "狄多, 迦太基的創建女王, 在夜間立於宮殿露台之上. 她身後, 天空深藍並點綴繁星, 遠處海岬在矮欄上方的天際線隱約可見. 一張弧形石凳立於她背後, 凳端雕有卷草飾帶, 淡色石柱在其後方聳立. 露台兩側, 兩株種植於淡色石盆中的大灌木生有深色葉片與細小紅色花朵: 石榴, 其拉丁文名 punicum 標誌着這是迦太基之樹. 她膚色白皙, 深色秀髮中分垂落過肩, 眉心戴有細金冠帶. 她的長袍是近乎白色的淡色希頓 (chiton), 即以別針固定於肩頭並束腰的希臘式束袍, 及地裙擺遍布細緻織紋. 短開衩袖以小胸針間隔固定於上臂, 一條寬闊的深藍腰帶環繞腰間, 向下長長垂掛於裙前. 她頸間橫陳一塊以金框鑲嵌深色寶石的寬胸飾, 一個纖細金手鐲圈繞手腕. 她雙手垂放於身側, 四周石材在星光下透出冷意."
CivVAccess_Strings["TXT_KEY_CIVVACCESS_LEADER_DESC_LEADER_BOUDICCA"] =
    "布狄卡, 愛西尼族女王, 立於山頂要塞的草坡之上. 左側是一道石牆, 牆頂架有削尖木樁組成的木柵欄, 圓形茅屋的錐形茅草屋頂隱約可見; 右側, 一列綠色山丘在沉重灰色天空下延伸而去. 她的頭髮短而鮮艷, 呈銅紅色, 一條淡色布條系於腦後, 向下垂落於肩後. 一側顴骨下方有一個深藍色小印記, 是古代不列顛人用作身體彩繪的菘藍. 一枚凱爾特扭繩金項圈 (torc), 金質扭製而成, 硬挺地環繞其頸. 她身穿無袖及膝的藍綠格紋粗布束腰短袍, 以帶圓形扣環的皮帶束腰. 皮製護腕以帶子繫於手腕上, 一個配套護甲束於上臂, 小腿在低矮皮靴上方裸露. 右手持一把直刃雙鋒的拉泰訥式短劍 (La Tene), 握於其金色護手之下, 刀身平面橫擱於她攤開的左掌之上. 一把長矛斜倚於她右臂, 矛尾插入草地. 她左側橫向停著一輛輕型雙輪戰車, 近側車輪為輪輻式並鑲有鐵圈. 車床中斜插着一束長矛."
CivVAccess_Strings["TXT_KEY_CIVVACCESS_LEADER_DESC_LEADER_WU_ZETIAN"] =
    "武則天, 唐朝皇帝, 立於昏暗廳堂正中, 兩側各有厚重的紅色簾幕向外拉開. 她身後, 一排溫暖的金色燈籠懸於黑暗之中, 其後的深色牆面嵌有鏤刻格扇板. 她的烏黑秀髮高高盤聚於頭頂, 前方以步搖 (buyao) 固定, 步搖為金珠飾件. 她身着襦裙 (ruqun), 多層疊穿. 淡金色絲質內衫交叉於胸前, 上方是一塊繡有圓形徽章的硬挺金色胸板; 一條鮮艷的紅色腰帶高束胸下, 向下垂落至地的長裙. 外披一件深紅色金色圓形圖案絲質外袍, 寬闊衣袖垂過雙手, 曳地的裙擺在腳周鋪展開來. 她雙手捧持一個小型金制器皿置於腰前, 微微上舉如呈獻之姿. 她膚色瑩白, 神情沉靜, 目光平和. 紅色簾幕, 紅色袍服與金色燈籠在廳堂的幽暗中將畫面染得溫暖."
CivVAccess_Strings["TXT_KEY_CIVVACCESS_LEADER_DESC_LEADER_HARALD"] =
    "哈拉爾一世, 綽號'藍牙'的貢姆松, 丹麥與挪威之王, 站在一艘長船的露天甲板中部. 他體型寬大壯碩, 鬍鬚呈紅金色, 分叉成兩條編成辮子的尾巴垂至衣領以下, 八字鬍長而下垂. 頭部裸露, 頭髮盤成髮髻. 肩上披著一件長毛棕紅色皮草斗篷. 斗篷下穿一件灰綠色束腰外衣, 育克部分顏色更深, 衣擺和袖口飾有北歐交錯紋的皮革壓花帶. 一條寬厚的皮革腰帶橫跨腰間, 以沉重的方形扣環固定, 另有一條皮帶斜跨胸前; 雙手均放在腹前的腰帶上. 頭盔置於腳旁甲板上, 為深鐵色圓頂, 有加固的眉帶和鼻橋, 兩側外展為厚棕紅色毛皮的圓形護耳. 左側船首柱高高彎曲向內呈螺旋形木雕, 刻成龍頭模樣. 右肩後方索具從桅杆垂下, 其上一面風帆掛著紅白相間的寬條紋. 沿船舷固定著一面圓形木盾正面朝外, 中央有鐵製臍盾. 頭頂天空開闊湛藍, 點綴著高層雲帶."
CivVAccess_Strings["TXT_KEY_CIVVACCESS_LEADER_DESC_LEADER_RAMESSES"] =
    "拉美西斯二世, 兩地法老, 端坐於數級矮台階頂端的寶座上, 兩側各是一座高大藍色彩繪廊柱廳堂. 他面容年輕, 面部剃淨, 皮膚深銅色, 眼眶以深色眼線粉描繪. 頭飾為nemes, 即金藍條紋頭巾, 緊貼太陽穴收攏, 再以褶疊長耳垂落胸前. 額頭升起uraeus, 即標示王權的人立眼鏡蛇. 肩部和胸前橫覆wesekh, 即以金色和青金石藍珠串層疊排成的寬領圈. 身穿shendyt, 即以長條白亞麻布製成的法老式褶裥短裙, 腰間以一條金藍寬腰帶束緊, 正面垂落一塊硬挺的圖案飾板. 雙腳穿涼鞋踏在台階頂級. 左手持高杖靠在肩上, 右手擱在寶座扶手上. 兩側廊柱以藍, 金, 紅色分排彩繪, 柱頭形如紙莎草束, 刻有成排象形文字和立像人物. 寶座前方兩側各立著兩尊大型金像, 分別為保護神伊西斯與奈芙蒂絲, 她們翅膀展開向前伸展, 羽毛呈現為長條鍍金葉片. 兩側棕櫚葉斜伸入畫, 腳下黃色石階刻著一排排小三角紋飾. 整座廳堂沐浴在暖金色光輝中, 廊柱與項圈的藍色是其中唯一的冷色調."
CivVAccess_Strings["TXT_KEY_CIVVACCESS_LEADER_DESC_LEADER_ELIZABETH"] =
    "伊莉莎白一世, 承蒙上帝恩典的英格蘭, 法蘭西及愛爾蘭女王, 信仰的守護者, 端坐於一張高大的雕刻王座之上, 兩側各有一座石基燭台, 蠟燭尚未點燃. 她身後升起御用頂篷, 厚重的紅色天鵝絨被金色流蘇繩向兩側拉起層層皺褶, 寢殿深處的幽暗僅隱約可見. 她的頭髮高高盤起, 呈紅金色緊密鬈曲, 以一頂嵌有寶石的小王冠固定; 衣領是都鐸晚期宮廷特有的硬挺開放式拉夫領. 她的長袍以黑線繡於金色錦緞之上, 胸衣裁剪貼身並綴滿寶石, 袖子於肩部膨起並向下收窄至蕾絲袖口, 裙擺在撐裙架 (farthingale) 上寬闊展開. 長串珍珠項鍊橫越胸前並垂掛腰間, 是她那個時代象徵貞潔的飾物. 她蒼白的雙手靜置於王座扶手之上."
CivVAccess_Strings["TXT_KEY_CIVVACCESS_LEADER_DESC_LEADER_SELASSIE"] =
    "海爾·塞拉西一世, 衣索比亞皇帝, 上帝的選民, 猶大支派征服之獅, 站在宮殿的一間長形接見廳中, 頭頂是淡色方格藻井天花板. 高大的窗戶沿他右側牆面排列, 一盞水晶吊燈懸於頭頂. 他身形清瘦挺拔, 蓄著深色鬍鬚, 頭髮剪得很短. 他身穿深色軍式束腰外衣, 釦子扣至喉間, 配素色深色長褲, 腰間繫著寬大的黑色皮腰帶. 從右肩斜跨至左臀, 繫著一條寬闊的翠綠色波紋綢綬帶, 即所羅門印章勳章的綬帶. 左胸高處密集排列著四排小型綬帶, 是他在位期間累積的戰役與榮譽勛飾. 其下垂掛著兩枚大型高級帝國勳章的胸星, 八角形, 以金與琺瑯精工製成. 他的左手垂放在身側, 右手持著一副手套. 他左側立著帝國王座: 一把高背椅, 以淡奶油色和藍色軟墊包覆, 椅背頂端雕成弧形冠狀並覆以刺繡布幔, 置於一塊鋪滿大廳的紅色花紋地毯之上. 他身後牆壁沿線排列著淡色軟墊椅, 向廳內深處延伸."
CivVAccess_Strings["TXT_KEY_CIVVACCESS_LEADER_DESC_LEADER_NAPOLEON"] =
    "拿破崙, 法蘭西皇帝, 騎跨於一匹淡灰色馬上, 置身暮色中一片枯草原野, 身後是紅褐色天空與光禿樹木. 他身穿深藍色外套配厚重金色肩章, 白色背心, 白色馬褲, 和高筒黑色騎靴. 雙角帽橫向佩戴, 兩個帽角朝向肩膀, 這是他刻意與麾下軍官有所區別的慣常佩戴方式. 馬的轡頭為紅色皮革鑲金鉚釘, 其下馬鞍布飾以紅金色邊. 整體構圖令人聯想到雅克-路易·大衛的《拿破崙越過阿爾卑斯山》, 然而靜止無動: 沒有人立的戰馬, 沒有指向遠方的手, 只有一個人在暮色山野中獨自佇立."
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_LEADER_DESC_LEADER_PACHACUTI"] =
    "帕查庫提印加·尤潘基 (Pachacuti Inca Yupanqui), 塔萬廷蘇尤 (Tahuantinsuyu) 的薩帕印加 (Sapa Inca), 端坐於馬丘比丘 (Machu Picchu) 上方露台的高大石制王座之上, 王座雕刻着以金紅兩色點綴的連鎖幾何紋飾. 他右上方固定於石柱的, 是一枚巨大的金色太陽圓盤, 中央呈現一張程式化的人面, 外圍放射狀光芒向外擴散. 左側裸露的山峰陡然聳立, 下方階梯式農業台地上排布着低矮的茅草建築. 他頭戴馬斯卡帕伊查 (mascapaycha), 即橫垂額前以象徵印加王權的紅色羊毛流蘇, 以亞烏托 (llauto) 多彩頭帶束固, 頂部插有一束挺立的紅色和深色羽毛. 他的頭髮烏黑, 垂及肩頭. 頸間掛有一枚厚重的金色圓盤胸飾. 他的束腰短袍是無袖及膝的服裝, 以醒目的黑白棋盤格圖案為主, 胸前飾有紅金色過肩橫帶. 膝蓋以下, 雙腿以紅色流蘇繩纏繞束紮. 右手持一根高大權杖, 頂端為金色鳥形飾件, 杖身懸掛層層疊疊的紅色流蘇."
CivVAccess_Strings["TXT_KEY_CIVVACCESS_LEADER_DESC_LEADER_GANDHI"] =
    "莫罕達斯·卡拉姆昌德·甘地, 聖雄, 印度獨立運動的領袖, 站在印度海岸邊, 四周是枯黃的草地, 岩石嶙峋的海岬, 以及蒼白的海面. 他身形消瘦, 頭頂禿光, 戴著眼鏡, 蓄著修剪整齊的灰色短鬍鬚. 他穿著晚年的慣常裝束: 一件圍繫腰間的白色 dhoti (圍腰布), 一條披肩搭在一側肩膀上並繞過另一側手臂下方, 胸部裸露. 布料未經染色且為手工紡織, 這是對英國布料的蓄意拒絕, 後來成為他的運動的象徵. 這一場景令人聯想到他在爭取獨立的鬥爭期間向海邊長途跋涉, 在次大陸的邊緣孑然而立的形象."
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_LEADER_DESC_LEADER_HIAWATHA"] =
    "海華沙, 易洛魁聯盟的創立者, 站在陽光照耀的林中空地上, 一塊大型灰色岩石在他肩旁聳立, 身後是細細的山毛櫸與白樺樹幹, 漸漸沒入綠色灌叢之中. 他袒露上身, 體型精瘦, 在斑駁光影中皮膚呈現溫暖的棕色. 髮型為scalplock式, 頭兩側剃短, 頭頂從前至後留有一條狹窄的深色髮脊, 後方固定兩根直立羽毛. 深色顏料帶環繞每條上臂. 喉間佩戴一條緊貼的白色貝珠項圈, 即wampum, 一條單肩帶從右肩斜至左臀, 支撐著一個箭囊, 羽尾端高出肩膀. 腰間掛著一塊淡棕色鹿皮遮羞布, 前片長垂至大腿中部. 有流蘇的鹿皮護腿套從腳踝包至膝蓋, 膝下紮緊, 大腿處敞開由遮羞布覆蓋. 他赤腳站在空地的夯實土地上, 雙臂垂於兩側, 林中光線從右側灑落."
CivVAccess_Strings["TXT_KEY_CIVVACCESS_LEADER_DESC_LEADER_ODA_NOBUNAGA"] =
    "織田信長, 織田氏大名, 三位偉大統一者中的第一位, 站立於一片起伏綠野之中, 四周高草叢生, 白石散落, 蔚藍山脈在積雲明天下向地平線退遠. 他以月代風格剃去頭頂, 前額與頭頂俱剃以使頭盔戴得涼爽穩固, 餘下髮絲束於腦後. 他蓄著短鬚和下巴短髭. 鎧甲為當世具足, 即戰國時代現代型胸甲: 漆塗鐵板以絲繩橫向排列縛結, 胸甲與裙甲以深藍與朱紅交替色帶束紮. 肩甲以同樣縛結鐵板懸垂於兩臂之上. 外披無袖棕褐色陣羽織, 前幅敞開露出其下縛結的胸甲. 寬幅紅色腰帶打結繫腰, 一把刀刃朝上插入其中, 右側另懸一把刀, 右手握著刀柄. 兩者合稱大小刀, 即每位武士所佩的長短雙刀. 從右肩後方升起, 橫跨背部的是一桿種子島銃的長形深色槍托與細長槍管, 那是信長以大規模採用而留名史冊的火繩槍. 他獨立於曠野之中, 四周只有草地, 白石與遠山."
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_LEADER_DESC_LEADER_PACAL"] =
    "巴加爾二世, B'aakal的K'uhul Ajaw, 帕倫克聖主, 正午時分站立於首都上方一座石灰岩宮殿的露台, 叢林之中逐級聳立的金字塔神廟超越其後, 屋頂梳飾因雕刻與風化而呈淡玫瑰色. 背後肩頭展開一架巨大背架, 木框上展開長長的quetzal尾羽, 以綠色, 藍色和深紅色帶狀排列, 架設於一塊刻有彩繪象形文字的長方形石板之上. 頭飾高大多層, 頂端更冠以quetzal羽毛. 長髮深黑垂落至肩. 胸前橫覆一排寬幅雕刻玉牌項圈, 中央懸掛一塊方形玉胸飾, 耳垂貫穿玉製大耳環. 串珠腰帶束攏腰部一條以打結布料和羽毛製成的腰裙, 兩側垂掛及膝的長羽流蘇, 腳踝上高繫涼鞋帶. 左手握著K'awiil的人偶權杖, 是一根頂部刻有閃電神小雕頭的高杖, 馬雅統治者以此神像作為王權象徵. 左側露台邊緣立著一個寬大石製火盆, 盆沿環繞著燒盡的祭品殘存. 城市遠景沒入薄霧, 座座金字塔逐級降向遠處的河流平原."
CivVAccess_Strings["TXT_KEY_CIVVACCESS_LEADER_DESC_LEADER_GENGHIS_KHAN"] =
    "成吉思汗, 蒙古大汗, 騎乘黑馬立於遼闊草原之上, 畫面呈現腰部以上, 四分之三側身面向觀者. 他的頭盔高聳呈錐形, 頂部以尖飾收束, 深色眉帶與護頰板框托着細薄的髭鬚與頦下一小撮鬍鬚. 他的盔甲是鉚釘固定的蒙古騎兵甲冑, 胸前以一枚大型圓形青銅飾件為主, 上面壓印盤旋圖案; 寬闊護肩蓋於雙肩, 釘飾臂帶纏繞上臂. 一件深色披風自肩頭垂落, 垂掛馬鞍後方處的內裡呈低調紫色. 馬匹的鞍具是素面皮革, 簡單的轡頭僅有眉帶與向前匯聚的韁繩. 他身後, 低矮的翠綠山丘在蒼白陰雲天空下起伏延展; 山坡中段矗立着一片蒙古包 (gers) 的營地, 即蒙古人的圓形白色氈帳, 周圍草地上點綴着淡色的散養牲口."
CivVAccess_Strings["TXT_KEY_CIVVACCESS_LEADER_DESC_LEADER_AHMAD_ALMANSUR"] =
    "艾哈邁德·曼蘇爾, 摩洛哥薩阿德王朝蘇丹, 站在撒哈拉營地的邊緣, 頭頂是深藍色的天空. 細細的新月與散落的星辰懸掛在地平線上低矮的黑色山脈之上. 他蓄著鬍鬚, 在燈光映照下膚色溫暖, 目光平靜地朝向觀者. 他身著馬格里布的層疊服飾: 一件長及腳踝的白色 djellaba (北非連帽長袍). 外面披著一件 selham (王侯貴族穿著的精細羊毛披風), 風帽垂落於肩胛骨之間. 頭上纏繞著白色頭巾. 胸前掛著一塊乳白與金色相間的矩形刺繡飾板, 以伊斯蘭幾何交錯紋樣裝飾. 一條寬大的紅白豎條紋腰帶繞腰兩圈, 在前方打結, 末端掖入腰間. 他身後左側, 一頂深色條紋布料製成的大圓形商隊帳篷由內透出光芒, 掀起的帳簾將溫暖的橙色光線灑在沙地上; 兩頭駱駝臥在旁邊的沙地上. 更遠處燃著一盞小燈, 一叢棗椰樹映襯著遠山升起."
CivVAccess_Strings["TXT_KEY_CIVVACCESS_LEADER_DESC_LEADER_WILLIAM"] =
    "威廉一世, 奧蘭治親王, 荷蘭獨立之父, 立於一間鋪磚廳室之中, 左側一扇高大的鑲鉛玻璃窗透入光線, 菱形小玻璃格由向側拉開的厚重紅色垂幔框托. 地面鋪設黑白大理石方格. 他身後遠牆掛有一幅鑲鍍金畫框的低地風景油畫, 描繪沉重天空下一條河流蜿蜒穿越平坦綠野通向遠處城鎮. 他右側, 一張木凳上放置一個地球儀, 黃銅子午儀圈接住窗光閃爍. 他左側, 一張鋪有紅色桌布的書桌上擺放着一本翻開的皮裝書和散頁紙張, 書桌後方立有一張包覆藍色布料的高背椅. 整個室內令人聯想起維梅爾筆下地理學家與天文學家的書房. 他是一位中年蓄鬚男子, 深色頭髮在小扁帽下剪得極短, 髭鬚和分叉鬍鬚修剪整齊, 一道寬闊的白色打褶拉夫領突出於頸間. 肩上垂有一件長黑色披風, 右側向後撥開以解放雙臂. 他的緊身上衣 (doublet) 是暗金色提花絲織, 貼身裁剪, 前胸以單排鈕扣扣合. 他的馬褲是分布式燈籠褲 (paned trunk hose), 由長條垂直的紅白布條交替排列縫製於較豐厚的襯裡之上, 至大腿中段收束. 素色深色長統襪包覆小腿以下, 與棋盤格地面上的低矮皮鞋相接. 右手持一根官職指揮棒, 舉至胸口高度; 左手靠近髖部, 披風垂落之下隱約可見劍柄."
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_LEADER_DESC_LEADER_DARIUS"] =
    "大流士一世, 偉大的阿契美尼德帝國萬王之王, 站立於一座大廳頂端的數級矮台階上, 一道光柱從上方投落其身. 他寬肩濃鬚, 鬍鬚修長方切且緊密捲曲. 頭上戴著kidaris, 即波斯諸王的高聳雉堞形冠冕, 是環繞方形雉堞的金色圓筒形冠. 長袍為藏紅花黃色長衫, 垂落至腳, 胸口, 袖口及下擺均飾以紅金色刺繡寬邊. 紅色腰帶束腰. 沉重的金臂環箍住雙臂上臂. 兩側台座各立著一尊巨大的lamassu有翼牛, 牛身及折疊翅膀皆覆蓋金色, 是波斯波利斯萬國之門的守護神像, 此處呈現人首版本簡化為純牛形. 後壁浮雕刻著一列身著長袍, 頭戴軟帽的人物行列, 取材自Apadana台階的納貢者浮雕. 台座和台階的石材呈淡藍綠色, 角落處點綴金色凸飾."
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_LEADER_DESC_LEADER_MARIA_I"] =
    "瑪麗亞一世, 葡萄牙及阿爾加維女王, 海外葡萄牙領地之君, 站立於辛特拉佩納宮露台上, 是一座重型仿羅馬式拱廊下的淡色石廊. 大西洋在廊柱之外展開. 她的裙裝為深藍色絲綢. 緊身胸衣貼身收腰, 及肘袖口以白色袖邊收尾, 裙身蓬鬆撐於裙撐之上, 大幅褶層垂落石面. 短紅色披風固定於肩部並拖曳其後. 胸前橫披一條寬幅白色紅邊飾帶, 即葡萄牙基督騎士團的綬帶, 由葡萄牙君主以大團長身份佩戴. 飾帶正面縫有一排珠寶裝飾. 深色頭髮盤高, 堆疊於額頭上方, 以一枚aigrette固定, 即插著直立羽毛的黑色小頭飾. 右手垂於身側, 搭在一根細長節杖的柄上, 深色杖身斜倚其藍色裙裝. 右側越過欄杆, 一條狹窄海灣在紅色峭壁之間延伸. 兩艘Naus, 即橫帆的葡萄牙帆船, 收起帆布錨泊於水道中. 左側聳立著一座黃色圍牆高塔, 頂部冠以鍍金與彩磁帶狀球形圓頂. 黃色雉堞城垛逐級降向她所站立的露台. 天空晴朗, 午後光線在大西洋上明亮閃耀, 拱廊將她框於一側海水與另一側皇家建築之間."
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_LEADER_DESC_LEADER_CATHERINE"] =
    "凱薩琳二世, 全俄羅斯女皇兼專制君主, 站在沙皇村葉卡捷琳娜宮大廳 - 光明廳之中. 她的身體以四分之三角度朝向觀者, 目光平靜. 她的深色頭髮高高梳起, 梳成十八世紀末歐洲宮廷流行的髮式. 頭頂以一頂小型寶石王冠束緊, 冠尖的形狀如同俄羅斯大帝國皇冠的高聳花形拱頂的縮影. 她的禮服是象牙色絲綢宮廷裝: 收身胸衣正面有一塊金線繡制的中央飾板, 深藍色泡泡半袖, 肩部以白色貂皮帶裝飾. 寬大的裙擺向下展開, 以金線繡著俄羅斯皇家紋章的雙頭鷹, 作為重複紋飾散布其上. 從右肩斜跨至左臀, 繫著一條寬闊的淡藍色波紋綢綬帶, 即聖安德魯第一召使勳章的綬帶. 右側牆面一排高聳的拱形窗戶掛著淡藍色窗帘, 帘子以弧形向兩側收起, 白晝的光線以清晰的光柱斜射在拋光如鏡的黑白大理石地板上. 左側牆面一排鎏金洛可可雕刻, 渦卷紋與葉形紋交織, 裝飾著鑲嵌鏡面的壁板."
CivVAccess_Strings["TXT_KEY_CIVVACCESS_LEADER_DESC_LEADER_POCATELLO"] =
    "波卡特洛, 西北肖肖尼族酋長, 坐於山間盆地邊緣一堆風化紅色巨石之上, 身後是一片平坦的鼠尾草平原, 延伸至地平線上以玫瑰色和淡紫色黃昏天色為背景的低矮台地剪影. 他肩膀寬闊, 烏黑長髮中分垂至胸前, 腦後固定一根挺立的鷹羽. 第二根深色羽毛從背後箭袋中升起, 探出肩後. 一把短木弓與箭袋並排斜挎, 弓的上肢突出於右肩之上. 右手持一根長矛豎立於岩石上, 矛柄以獸皮纏繞, 靠近矛頭處垂有一束深色毛簇. 上身穿一件毛皮背心, 一條以鞣皮製成的寬帶斜橫其上, 帶面以排列整齊的串珠工藝裝飾, 從右肩延伸至左髖, 下端懸掛一個短刀鞘. 上臂以層疊的銀色臂環纏繞. 腰部以下穿着深色流蘇皮革護腿垂至腳踝, 中間束有纏腰布. 左手手掌朝上擱在大腿上; 姿態靜止, 重心穩落於岩石之上. 光線低斜而溫暖, 照亮岩石的紅色和矛刃的邊緣. 平原在他身後延展沒入大盆地, 即落基山脈與內華達山脈之間的肖肖尼族故土."
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_EO_COL_GOLDEN_AGE"] = "黃金時代點數"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_EO_COL_PRODUCTION"] = "生產"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_EO_COL_DEMAND"] = "需求"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_EO_UNHAPPY_CITIZENS"] = "不滿市民, {1_Value}"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_EO_HAPPY_MILITARY_UNITS"] = "軍事單位, {1_Value}"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_EO_HAPPY_ANNEXED_CITY_STATES"] = "已吞併城邦, {1_Value}"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_EO_UNHAPPY_WAR_WEARINESS"] = "戰爭疲勞, {1_Value}"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_EO_UNHAPPY_OCCUPIED_POPULATION"] = "被佔領城市人口, {1_Value}"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_EO_UNHAPPY_PUPPET_POPULATION"] = "傀儡城市人口, {1_Value}"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_EO_UNHAPPY_FAMINE"] = "饑荒, {1_Value}"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_EO_UNHAPPY_PILLAGED"] = "劫掠地格, {1_Value}"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_EO_UNHAPPY_ISOLATION"] = "孤立, {1_Value}"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_EO_UNHAPPY_UNITS"] = "單位, {1_Value}"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_EO_UNHAPPY_DISTRESS"] = "困苦, {1_Value}"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_EO_UNHAPPY_POVERTY"] = "貧困, {1_Value}"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_EO_UNHAPPY_ILLITERACY"] = "文盲, {1_Value}"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_EO_UNHAPPY_BOREDOM"] = "無聊, {1_Value}"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_EO_UNHAPPY_RELIGIOUS_UNREST"] = "宗教動盪, {1_Value}"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_EO_UNHAPPY_SPECIALISTS"] = "專家, {1_Value}"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_EO_UNHAPPY_PUPPET_SPECIALISTS"] = "傀儡城市專家, {1_Value}"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_EO_UNHAPPY_BUILDINGS"] = "建築, {1_Value}"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_EO_RES_FROM_CITY_STATES"] = "來自城邦"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_SCREEN_MAP_SETTINGS"] = "地圖設定"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_MAP_SETTINGS_HOTKEY_HELP_KEY"] = "Control 加 M"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_MAP_SETTINGS_HOTKEY_HELP_DESC"] = "開啟地圖顯示設定"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_MAP_SETTINGS_HELP_DESC_CLOSE"] = "關閉地圖設定"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_BOOKMARK_HELP_DESC_JUMP"] = "跳轉游標至該位置的書籤, 退格鍵返回"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_BOOKMARK_HELP_KEY_DIRECTION"] = "Alt 加數字鍵"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_BOOKMARK_HELP_DESC_DIRECTION"] = "游標至該位置書籤的距離與方向"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_BOOKMARK_MODE_MAP"] = "地圖書籤"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_BOOKMARK_MODE_UNIT"] = "單位書籤"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_BOOKMARK_NO_UNIT"] = "未選取單位"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_UNIT_BOOKMARK_ADDED"] = "單位已加入書籤"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_UNIT_BOOKMARK_ADDED_NAMED"] = "{1_Name} 已加入書籤"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_UNIT_BOOKMARK_EMPTY"] = "無單位書籤"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_UNIT_BOOKMARK_GONE"] = "單位已不存在"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_BOOKMARK_HELP_KEY_MODE"] = "Control 加 B"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_BOOKMARK_HELP_DESC_MODE"] = "切換地圖與單位書籤模式"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_BEACON_HELP_DESC"] = "切換該位置書籤的空間音訊標示點"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_MSGBUF_HELP_KEY_NAV_AZERTY"] = "右圓括號與等號"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_MSGBUF_HELP_KEY_NAV_QWERTZ"] = "U分音與加號"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_MSGBUF_HELP_KEY_NAV_ITALIAN"] = "E重音與加號"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_MSGBUF_HELP_KEY_EDGE_AZERTY"] = "Control 加 右圓括號與等號"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_MSGBUF_HELP_KEY_EDGE_QWERTZ"] = "Control 加 U分音與加號"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_MSGBUF_HELP_KEY_EDGE_ITALIAN"] = "Control 加 E重音與加號"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_MSGBUF_HELP_KEY_FILTER_AZERTY"] = "Shift 加 右圓括號與等號"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_MSGBUF_HELP_KEY_FILTER_QWERTZ"] = "Shift 加 U分音與加號"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_MSGBUF_HELP_KEY_FILTER_ITALIAN"] = "Shift 加 E重音與加號"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_MSGBUF_HELP_DESC_FILTER"] = "切換記錄篩選類別, 跳過空類別"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_CHAT_HOTKEY_HELP_KEY"] = "反斜線"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_CHAT_HOTKEY_HELP_KEY_AZERTY"] = "星號"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_CHAT_HOTKEY_HELP_KEY_QWERTZ"] = "井號"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_CHAT_HOTKEY_HELP_KEY_ITALIAN"] = "U重音"
...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_INGAME_CHAT_HELP_KEY_CLOSE_AZERTY"] = "星號或 Escape"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_INGAME_CHAT_HELP_KEY_CLOSE_QWERTZ"] = "井號或 Escape"
CivVAccess_Strings["TXT_KEY_CIVVACCESS_INGAME_CHAT_HELP_KEY_CLOSE_ITALIAN"] = "U重音或 Escape"
