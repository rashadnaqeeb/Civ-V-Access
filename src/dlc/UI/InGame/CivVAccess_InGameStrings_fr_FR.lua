...
CivVAccess_Strings["TXT_KEY_CIVVACCESS_TARGET_HELP_DESC_WAYPOINT_PREVIEW"] = "Prévisualiser le déplacement depuis le dernier point de passage en file d'attente vers la case cible"
