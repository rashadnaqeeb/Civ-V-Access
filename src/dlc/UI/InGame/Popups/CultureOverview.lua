...
g_YourCultureSortOptions = {
	...
	{
		Button = Controls.AmphitheaterButton,
		Column = "AmphitheaterSort",
		DefaultDirection = "desc",
		CurrentDirection = nil,
		SortType = "numeric",
	},
	{
		Button = Controls.OperaHouseButton,
		Column = "OperaHouseSort",
		DefaultDirection = "desc",
		CurrentDirection = nil,
		SortType = "numeric",
	},
	{
		Button = Controls.MuseumButton,
		Column = "MuseumSort",
		DefaultDirection = "desc",
		CurrentDirection = nil,
		SortType = "numeric",
	...
	{
		Button = Controls.BroadcastTowerButton,
		Column = "BroadcastTowerSort",
		DefaultDirection = "desc",
		CurrentDirection = nil,
		SortType = "numeric",
	},
	...
	{
		Button = Controls.NationalEpicButton,
		Column = "NationalEpicSort",
		DefaultDirection = "desc",
		CurrentDirection = nil,
		SortType = "numeric",
	},
	{
		Button = Controls.HeroicEpicButton,
		Column = "HeroicEpicSort",
		DefaultDirection = "desc",
		CurrentDirection = nil,
		SortType = "numeric",
	},
    ...
    for _, cityData in ipairs(g_YourCulture) do
        ...
        for buildingIndex, buildingData in ipairs(cityData.Buildings) do
            ...
            if (buildingData.HasBuilding) then
				...
				for greatWorkSlotIndex = 1, buildingData.GreatWorkSlotCount, 1 do
...
function SelectYourWork (iIndex)
	...
	if (iIndex == -1) then
		...
		CivIconHookup(activePlayerID, 32, Controls.SwapYourWorksSubIcon, Controls.SwapYourWorksSubIconBG, Controls.SwapYourWorksSubIconShadow, true, true, Controls.SwapYourWorksSubIconHighlight);
...
function SelectOthersWork (iIndex) 
	...
	if (iIndex == -1) then
		...
		CivIconHookup(g_iTradingPartner, 32, Controls.SwapTheirWorksSubIcon, Controls.SwapTheirWorksSubIconBG, Controls.SwapTheirWorksSubIconShadow, true, true, Controls.SwapTheirWorksSubIconHighlight);
...
function RefreshSwappingItems()
	...
	CivIconHookup(activePlayerID, 32, Controls.YourWorksSubIcon, Controls.YourWorksSubIconBG, Controls.YourWorksSubIconShadow, true, true, Controls.YourWorksSubIconHighlight);
...
function DisplayOthersWorks ()
	...
	for i,v in ipairs(OthersGreatWorks) do
		...
		CivIconHookup(v.iPlayer, 32, SwapWorkLineInstance.SubIcon, SwapWorkLineInstance.SubIconBG, SwapWorkLineInstance.SubIconShadow, true, true, SwapWorkLineInstance.SubIconHighlight);
...
include("CivVAccess_CultureOverviewAccess")
