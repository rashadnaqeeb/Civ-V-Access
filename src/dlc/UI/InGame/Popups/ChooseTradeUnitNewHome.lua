...
function RefreshList()
	...
	for i,v in ipairs(potentialNewHomes) do
		...
		itemInstance.CityName:LocalizeAndSetText("TXT_KEY_CHANGE_TRADE_UNIT_HOME_CITY_ITEM_CITY", pTargetCity:GetName());
...
include("CivVAccess_ChooseTradeUnitNewHomeAccess")
