...
Map = Map
    or {
        GetPlot = function(_x, _y)
            return nil
        end,
        GetPlotXY = function(_x, _y, _dx, _dy)
            return nil
        end,
        GetPlotByIndex = function(_i)
            return nil
        end,
        PlotDirection = function(_x, _y, _dir)
            return nil
        end,
        PlotDistance = function(_x1, _y1, _x2, _y2)
            return 0
        end,
...
function Polyfill.makeLabel(initialText)
    ...
    function self:LocalizeAndSetText(k, ...)
        self._text = Locale.ConvertTextKey(k, ...)
    end
...
function Polyfill.makeButton()
    ...
    function self:SetVoid1(v)
        self._void1 = v
    end
    function self:SetVoid2(v)
        self._void2 = v
    end
    function self:SetVoids(v1, v2)
        self._void1, self._void2 = v1, v2
    end
    function self:GetVoid1()
        return self._void1
    end
    function self:GetVoid2()
        return self._void2
    end
    function self:IsHidden()
        return self._hidden
    ...
    function self:SetHide(h)
        self._hidden = h and true or false
    end
    function self:SetDisabled(d)
        self._disabled = d and true or false
    end
    function self:TakeFocus()
        self._hasFocus = true
    end
    function self:RegisterCallback(mouseEvent, fn)
        self._cbs[mouseEvent] = fn
    end
    return self
end
...
function Polyfill.makeSlider(opts)
    ...
    function self:RegisterSliderCallback(fn)
        self._cb = fn
    end
    function self:SetVoid1(v)
        self._void1 = v
...
function Polyfill.makeCheckBox(opts)
    ...
    function self:RegisterCheckHandler(fn)
        self._cb = fn
    end
    function self:IsHidden()
        return self._hidden
...
function Polyfill.makeEditBox(opts)
    ...
    function self:ClearString()
        self._text = ""
    end
    function self:RegisterCallback(fn)
        self._cb = fn
    end
    function self:TakeFocus()
        self._hasFocus = true
...
function Polyfill.makePullDown()
    ...
    function self:RegisterSelectionCallback(fn)
        self._selectCB = fn
    end
    function self:IsHidden()
        return self._hidden
