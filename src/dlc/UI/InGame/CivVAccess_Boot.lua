...
-- Custom-category model + F12 settings UI. After Core (reads the taxonomy)
-- and before Nav (feeds customCategoryDefs into every snapshot rebuild).
include("CivVAccess_ScannerFavorites")
...
include("CivVAccess_ScannerBackendWorkedTiles")
include("CivVAccess_ScannerBackendYields")
include("CivVAccess_ScannerBackendSpecial")
include("CivVAccess_ScannerBackendTerrain")
include("CivVAccess_ScannerBackendGeography")
...
include("CivVAccess_UnitMoveLog")
