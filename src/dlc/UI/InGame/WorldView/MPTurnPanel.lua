...
-- Target: Assets/UI/InGame/WorldView/MPTurnPanel.{lua,xml}. Contents above
-- the bootstrap marker are a verbatim copy of the base-game file. BNW does
-- not override this file; our base copy is what loads under the Expansion2
-- UISkin.
-------------------------------------------------
...
include("CivVAccess_MPTurnPanelAccess")
