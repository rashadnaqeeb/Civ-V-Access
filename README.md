...
- **Alt-tab freely.** The mod keeps the game running and audible while you're in another window, so you can switch away during a long AI turn and hear the game continue, including your turn-start announcement when it's your go. This needs the game in windowed mode — in the game's Options under Video, turn fullscreen off; in fullscreen the game pauses on focus loss and the mod can't prevent it. If you'd rather have the stock behavior (game goes silent and idle until you return), turn off **Keep game running in background** in **F12** settings, under the General settings group. While you're in another window the game ignores your typing either way, so there's no risk of stray keys reaching it.
