...
- `build-proxy.ps1` — compiles `lua51_Win32.dll` from `src/proxy/` to `dist/proxy/lua51_Win32.dll` (committed). Uses VS 2026's `cl.exe`. Re-run only when `src/proxy/` changes.
