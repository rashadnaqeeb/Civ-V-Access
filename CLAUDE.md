...
An install is in exactly one of several mutually exclusive states (vanilla, VP mod-overlay, VP modpack, CP modpack, LekMod); the running session type must match the last deploy, or the player hears silent wrong numbers.
