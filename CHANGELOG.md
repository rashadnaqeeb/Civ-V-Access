...
- Vox Populi and Community Patch support now tracks Vox Populi 5.4.6.
...
- The LekMod multiplayer lobby was checked action by action against what a sighted player can do there, and every gap was closed. Choosing a ban now opens a list of civilizations you can search by typing, and picking one closes the list and reads the slot back. You hear the draft rules when you join and whenever the host changes them, that your bans are no longer ready when a change clears them, your hand the moment the draft is dealt or swapped, and, as host, when a player hands you their bans or takes them back. Draft swaps and seat swaps both say what your press did, tell you when another player asks you, and a finished seat swap reads the seat you now hold, which is how you take over a civilization in a reloaded save. Civilization lists open on your current pick instead of Random, LekMod's Civilopedia button is in the menu, LekMod's AI Options and Additional Options sub-settings stay out of the menu while their headline is off, and the launch countdown keeps speaking after the lobby is rebuilt between games.
