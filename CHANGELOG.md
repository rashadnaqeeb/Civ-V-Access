...
- The directional scan now uses its own adjustable radius (1–10 tiles, default 3), independent of the surveyor radius. Inside the mode press Numpad plus / minus or the top-row plus / minus aliases to grow or shrink the radius; the new value is announced on each press and the word "max" or "min" is appended when the limit is reached.
