...
- LekMod's Lekmap Pangaea map now reports its progress while it regenerates. This is Lekmap v6.2, which rolls and rerolls till it finds a map that fits the conditions, which can take upwards of 5 minutes.
- The LekMod multiplayer lobby was generally massively improved, with many things that were not previously announced live now being announced.

Bug fixes:
- The Alt+direction attack confirm now is unit specific rather than tile specific. Whoops.
